...
- [earn-bounty-scanner](https://github.com/goblin-grub/earn-bounty-scanner) - MCP server exposing live Solana bounties from Superteam Earn: keyword search with rewards, deadlines, agent-access flags and full descriptions, plus per-bounty lookup and a recent-bounties feed. No API key.
